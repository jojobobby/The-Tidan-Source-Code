    ...
    internal class Oryx : IDisposable
    {
        ...
        private static readonly Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>
            spawn = new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>
            {
                ...
                },
                {
                    ...
                    100, new []
                    {
                        Tuple.Create("White Demon", 0.08),
                        Tuple.Create("Sprite God", 0.08),
                        Tuple.Create("Medusa", 0.08),
                        Tuple.Create("Ent God", 0.08),
                        Tuple.Create("Beholder", 0.08),
                        Tuple.Create("Bag Phoenix", 0.01),
                        Tuple.Create("Flying Brain", 0.08),
                        Tuple.Create("Slime God", 0.09),
                        Tuple.Create("Ghost God", 0.09),
                        Tuple.Create("Rock Bot", 0.05),
                        Tuple.Create("Djinn", 0.09),
                        Tuple.Create("Beetle", 0.09),
                        Tuple.Create("Black Knight", 0.07),
        ...
        public bool CheckFinalQuests()
        {
            ...
            if (CountEnemies(
                "Lich", "Actual Lich",
                "Hermit God",
                "lord of the Lost Lands", "Primaeval The Ancient Totem",
