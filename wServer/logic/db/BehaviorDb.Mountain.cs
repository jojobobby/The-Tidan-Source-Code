        ...
        private _ Mountain = () => Behav()
            .Init("White Demon",
                new State(
                    ...
                    new DropPortalOnDeath("Abyss of Demons Portal", 5),
                    new Prioritize(
                        new StayAbove(1, 200),
         ...
         .Init("Beetle",
                new State(
                    new DropPortalOnDeath("The Crawling Depths", 5),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
                ...
                new TierLoot(4, ItemType.Ring, 0.005),
                new Threshold(0.18,
                    new ItemLoot("Potion of Wisdom", 0.01)
                    )
            )
            ...
            .Init("Medusa",
                new State(
                    ...
                    new DropPortalOnDeath("Snake Pit Portal", 10)
                    ),
                new TierLoot(6, ItemType.Weapon, 0.04),
                new TierLoot(7, ItemType.Weapon, 0.02),
                new TierLoot(8, ItemType.Weapon, 0.01),
            ...
            .Init("Ent God",
                new State(
                        new DropPortalOnDeath("Woodland Labyrinth", 5),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
            ...
            .Init("Lucky Djinn",
                new State(
                    new DropPortalOnDeath("The Crawling Depths", 10),
                    new State("Idle",
                        new Prioritize(
                            new StayAbove(1, 200),
                            new Wander(0.8)
