        ...
        private _ RockDragon = () => Behav()
            .Init("Dragon Head",
                new State(
                    ...
                    new DropPortalOnDeath("Ivory Wyvern Portal", 75),
                    new State("default",
                ...
                new Threshold(0.05,
                    new ItemLoot("Arena Men's Blade", 0.009),
                    new ItemLoot("Scutum", 0.009),
                    new ItemLoot("Dragon Scale Armor", 0.009),
                    new ItemLoot("Physical Crown", 0.009),
